<?php
  ...
  $admin_01 = new Admin($_id_user = 01, $_nickname = "Liga", $_password = "radioreccia", $_age = 60, $_email = "ligabue@email.it", $_registration_date = "2000/05/18 22:02:05", 01);
  ...
  $admin_02 = new Admin($_id_user = 02, $_nickname = "WithinTemptation", $_password = "MetalHead", $_age = 46, $_email = "sharon@email.nl", $_registration_date = "2012/08/03 16:26:02", 02);
  // Checking that password, age and e-mail are valid values
  ...
  $admin_03 = new Admin($_id_user = 03, $_nickname = "caro", $_password = "figure_skating", $_age = 33, $_email = "carolina.kostner@email.it", $_registration_date = "2020/09/24 15:36:11", 03);
  // Checking that password, age and e-mail are valid values
